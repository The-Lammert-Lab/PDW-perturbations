...
% slope = line([xst 10.25],[yst (xst-10.25)*tan(gam)]);

% To make long line for viz
slope = line([xst 30],[yst (xst-30)*tan(gam)]);

set(slope,'Color','k','LineWidth',0.1);

% horiz = line([xst 10.25],[(xst-10.25)*tan(gam) (xst-100.25)*tan(gam)]);

horiz = line([xst 30],[(xst-30)*tan(gam) (xst-30)*tan(gam)]);


set(horiz,'Color','k','Linewidth',0.1);
