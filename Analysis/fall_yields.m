...
ratio = load('../Data/Gaitcycles combined n20000g0.014_0.019p0.02_0.5/fallratio1419NEWFALL.csv');
yield = load('../Data/Gaitcycles combined n20000g0.014_0.019p0.02_0.5/percentYield1419NEWFALL.csv');
